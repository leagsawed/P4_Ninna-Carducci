(function ($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    nextImage() {
      ...
      // Déterminer l'image suivante en utilisant la logique circulaire
      if (index >= imagesCollection.length - 1) {
        // Si l'index est à la dernière image, boucler à la première image
        next = imagesCollection[0];
      } else {
        // Sinon, prendre l'image suivante dans le tableau
